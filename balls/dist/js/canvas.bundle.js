...
function Particle(x, y, radius, color) {
    ...
    this.update = function (particles) {
        ...
        for (var i = 0; i < particles.length; i++) {
            ...
            if ((0, _utils.distance)(_this.x, _this.y, particles[i].x, particles[i].y) - (_this.radius + particles[i].radius) < 0) {
        ...
        if ((0, _utils.distance)(mouse.x, mouse.y, _this.x, _this.y) < 120 && _this.opacity < 0.3) {
            _this.opacity += 0.02;
    ...
    for (var i = 0; i < 200; i++) {
        ...
        if (i !== 0) {
            for (var j = 0; j < particles.length; j++) {
                var element = particles[j];
                if ((0, _utils.distance)(x, y, particles[j].x, particles[j].y) - (radius + particles[j].radius) < 0) {
